...
import com.company.projects.airBnbApp.dto.RoomPriceDto;
...
public interface InventoryRepository extends JpaRepository<Inventory,Long> {
    ...
    List<Inventory> findByLockAndAvailabilityInventory(
    ...
    @Query("""
       SELECT new com.company.projects.airBnbApp.dto.RoomPriceDto(
            i.room,
            CASE
