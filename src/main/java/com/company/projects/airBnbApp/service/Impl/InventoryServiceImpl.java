...
public class InventoryServiceImpl implements InventoryService {
    ...
    public Page<HotelPriceResponseDto> searchHotels(HotelSearchRequest hotelSearchRequest) {
        ...
        Page <HotelPriceDto> hotelPage =
                hotelMinPriceRepository.findHotelsWithAvailabilityInventory(hotelSearchRequest.getCity(),
    ...
    public List<InventoryDto> getAllInventoryByRoom(Long roomId) {
       ...
       if(!user.equals(room.getHotel().getOwner())) throw new UnAuthorisedException("You are not the owner of the room with id: "+roomId);
    ...
    User user = getCurrentUser();
    if(!user.equals(room.getHotel().getOwner())) throw new UnAuthorisedException("You are not the owner of room with id: "+roomId);
